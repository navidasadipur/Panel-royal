!(function (d) {
    ...
    function a() {
        !d(".lynessa-menu-clone-wrap").length &&
            0 < d(".lynessa-clone-mobile-menu").length &&
            d("body").prepend(
        ...
        Array();
        d(".lynessa-menu-clone-wrap .lynessa-menu-panels #lynessa-menu-panel-main").length ||
            d(".lynessa-menu-clone-wrap .lynessa-menu-panels").append('<div id="lynessa-menu-panel-main" class="lynessa-menu-panel lynessa-menu-panel-main"><ul class="depth-01"></ul></div>'),
    ...
    d(document).ready(function () {
        n(),
            ...
            d(document).on("click", ".lynessa-menu-next-panel", function (n) {
                ...
                if (d(l).length) {
                    ...
                    0 < d(".lynessa-menu-panels-actions-wrap .lynessa-menu-current-panel-title").length && (i = d(".lynessa-menu-panels-actions-wrap .lynessa-menu-current-panel-title").html()),
                        void 0 !== u && 0 != typeof u
                            ? (d(".lynessa-menu-panels-actions-wrap .lynessa-menu-current-panel-title").length || d(".lynessa-menu-panels-actions-wrap").prepend('<span class="lynessa-menu-current-panel-title"></span>'),
                              d(".lynessa-menu-panels-actions-wrap .lynessa-menu-current-panel-title").html(u))
            ...
            d(document).on("click", ".lynessa-menu-prev-panel", function (n) {
                ...
                if (void 0 === l || 0 == typeof l) d(".lynessa-menu-panels-actions-wrap .lynessa-menu-prev-panel").remove(), d(".lynessa-menu-panels-actions-wrap .lynessa-menu-current-panel-title").remove();
                else {
                    d(".lynessa-menu-panels-actions-wrap .lynessa-menu-prev-panel")
                        .attr("href", "#" + l)
                        .attr("data-cur-panel", t)
                        .attr("data-target", "#" + l);
                    var u = d("#" + l)
                        .find('.lynessa-menu-next-panel[data-target="' + t + '"]')
                        .closest(".menu-item")
                        .find(".lynessa-menu-item-title")
                        .attr("data-title");
...
jQuery(function (e) {
    "use strict";
    e("body")
        .on("init", ".lynessa-tabs-wrapper, .lynessa-tabs", function () {
        ...
        0 < e(".flex-control-nav, .lynessa-product-gallery__wrapper").length &&
            (e(".lynessa-product-gallery__wrapper").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, draggable: !1, fade: !0, asNavFor: ".flex-control-nav" }),
            e(".flex-control-nav").slick({
                ...
                focusOnSelect: !0,
                slidesMargin: 14,
                responsive: [{ breakpoint: 991, settings: { vertical: !1, slidesToShow: 3, prevArrow: '<span class="fa fa-angle-left prev"></span>', nextArrow: '<span class="fa fa-angle-right next"></span>' } }],
            })),
        ...
        $(document).on("click", function (a) {
            var t = $(a.target).closest(".lynessa-dropdown"),
                n = $(".lynessa-dropdown");
            0 < t.length
                ? (n.not(t).removeClass("open"), ($(a.target).is('[data-lynessa="lynessa-dropdown"]') || 0 < $(a.target).closest('[data-lynessa="lynessa-dropdown"]').length) && (t.toggleClass("open"), a.preventDefault()))
                : $(".lynessa-dropdown").removeClass("open");
        }),
        $(document).on("click", ".lynessa-tabs .tab-link a, .lynessa-accordion .panel-heading a", function (a) {
            ...
            1 != s || t.hasClass("loaded")
                ...
                : ($(e).closest(".tab-container,.lynessa-accordion").addClass("loading"),
                  t.parent().addClass("active").siblings().removeClass("active"),
                  $.ajax({
                      type: "POST",
                          ...
                          "ok" == a.success
                              ? ($(e).html($(a.html).find(".az_tta-panel-body").html()),
                                ...
                                0 < $(".owl-slick .product-item").length &&
                                    lynessa_hover_product_item($(e).find(".owl-slick .row-item,.owl-slick .product-item.style-1,.owl-slick .product-item.style-2,.owl-slick .product-item.style-3,.owl-slick .product-item.style-4")),
                                ...
                                t.addClass("loaded"),
                                $(o).html(""))
                              : ($(e).closest(".tab-container,.lynessa-accordion").removeClass("loading"), $(e).html("<strong>Error: Can not Load Data ...</strong>")),
                              t.closest(".panel-default").addClass("active").siblings().removeClass("active"),
                              t.closest(".lynessa-accordion").find(e).slideDown(400),
                              t.closest(".lynessa-accordion").find(".panel-collapse").not(e).slideUp(400);
                      },
            ...
            (s = u(".lynessa-mapper")),
                ...
                e.each(function () {
                    var t = u(this).data("top"),
                        s = u(this).data("left");
                    t.substr && "%" != t.substr(-1) && (t = (t / i) * 100 + "px"), s.substr && "%" != s.substr(-1) && (s = (s / a) * 100 + "px"), u(this).css({ top: t, left: s });
                }),
                (function () {
                    ...
                    t.on("click", function () {
                        ...
                        if (s.length) {
                            ...
                            if (s.hasClass("top") || s.hasClass("bottom")) {
                                s.css("left", 0);
                                var c = s.offset();
                                if (c.left <= 0) s.css({ left: -c.left }), s.addClass("remove-redirect");
                                else {
                                    if (n) var f = c.left + r;
                                    else f = c.left + l;
                                    if (r < f) {
                            ...
                            if ((u(".content-text").css({ "max-height": l - 80 + "px", overflow: "auto" }), u(".lynessa-mapper .lynessa-pin .lynessa-popup-header h2").css("max-width", l - 10), s.hasClass("lynessa-image"))) {
