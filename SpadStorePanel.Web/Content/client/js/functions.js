(function ($) {
    ...
    function lynessa_threesixty(ev) {
        var imageLink = (location.pathname.replace('single-product-360deg.html', '~/Content/client/images'));
...
$(document).ready(function () {
    $(".closingbtn").click(function (e) { 
        $(".block-minicart .widget_shopping_cart").css("right", "-450px" );
        $(".block-minicart").removeClass("open");

        
    });
    $(".block-menu-bar").click(function (e) { 
        $(".block-minicart .widget_shopping_cart").css("right", "-450px" );
        $(".block-minicart").removeClass("open");

        
    });
    $(".pe-7s-shopbag").click(function (e) { 
        $(".block-minicart .widget_shopping_cart").css("right", "0px" );
